...
A Python client library for interacting with Gallagher Command Centre security systems via their REST API.

.. note::
   **About Gallagher Command Centre**
   
   [Placeholder: Add information about Gallagher Command Centre security system]
...
.. code-block:: bash
   ...
   uv pip install gallagher_restapi

Or using ``pip``:

.. code-block:: bash

   pip install gallagher_restapi

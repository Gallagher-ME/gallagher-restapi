...
class Client:
    ...
    async def get_image_from_pdf(self, pdf_href: str) -> str | None:
        ...
        Returns:
            A base64 string of the image if found, None otherwise.
        """
    ...
    async def get_cardholder_changes_href(
        ...
        *,
        ...
        return models.FTItemReference.model_validate(response["next"])

    async def add_cardholder(
        self, cardholder: models.FTCardholder
    ) -> models.FTItemReference:
    ...
    async def update_cardholder(
        self,
        cardholder_href: str,
        patched_cardholder: models.FTCardholder,
    ) -> None:

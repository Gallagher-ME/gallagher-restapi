...
class FTBaseItem(FTItemReference):
...
class FTAccessGroup(FTItemReference):
...
class FTOperatorGroupMembership(FTItemReference):
    """FTOperatorGroupMembership item base class."""

    cardholder: FTLinkItem


class FTOperatorGroup(FTItemReference):
...
class FTCardType(FTItemReference):
...
class FTPersonalDataFieldDefinition(FTItemReference):
...
class FTLockerMembership(FTItemReference):
...
class FTCardholder(FTItemReference):
    ...
    # A list of assigned cards or a dict with 'add', 'update', 'remove' keys for PATCH.
    cards: list[FTCardholderCard] | FTCardholderCardsPatch | None = None

    # A list of assigned access groups or a dict with 'add', 'update', 'remove' keys for PATCH.
    access_groups: (
    ...
    # A list of assigned lockers or a dict with 'add', 'update', 'remove' keys for PATCH.
...
class FTEventAlarm(FTItemReference):
